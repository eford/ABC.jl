...
type abc_pmc_plan_type <: abc_plan_type
   ...
   function abc_pmc_plan_type(gd::Function,css::Function,cd::Function,p::Distribution;                          
     mpd::Function = make_proposal_dist_gaussian_full_covar, 
     ...
     new(gd,css,cd,p,mpd,normalize,is_valid, num_part,num_max_attempt,num_max_times,epsilon_init, init_epsilon_quantile,epsilon_reduction_factor,target_epsilon,tau_factor,save_summary_stats,in_parallel)
   end
end
...
type abc_summary_stats_log_type   # Not implemented yet
   ...
   function abc_summary_stats_log_type()
      new( Array(Array{Float64},0), Array(Array{Float64},0) )
   end
end
