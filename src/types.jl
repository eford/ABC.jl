...
type abc_pmc_plan_type <: abc_plan_type
   ...
   function abc_pmc_plan_type(gd::Function,css::Function,cd::Function,p::Distribution;
     ...
     num_part::Integer = 10*length(Distributions.rand(p))^2, num_max_attempt::Integer = 1000, num_max_attempt_valid::Integer = 100, num_max_times::Integer = 100, num_dist_per_obs::Int64 = 1, 
